...
import 'package:navy/features/profile/views/widgets/trashed_post_item.dart';

class TrashedPosts extends StatelessWidget {
  TrashedPosts({
    super.key,
    this.onTryAgain,
  ...
  final PagingController<int, TrashPost> pagingController;
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        PagedSliverList<int, TrashPost>(
          shrinkWrapFirstPageIndicators: true,
          pagingController: pagingController,
          addAutomaticKeepAlives: true,
          addRepaintBoundaries: true,
          builderDelegate: PagedChildBuilderDelegate<TrashPost>(
            itemBuilder: (context, post, index) => TrashedPost(post: post),
            ...
            firstPageErrorIndicatorBuilder: (context) => _buildEmptyState(
              ...
              subtitle:
                  pagingController.error?.toString() ?? "Failed to load posts",
